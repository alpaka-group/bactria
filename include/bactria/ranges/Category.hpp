...
namespace bactria
{
    namespace ranges
    {
        ...
        public:
             ...
             *
             * Constructs a category by moving \a other's properties into \a this. \a this will be identical to \a
             * other's state before the move. \a other will be in an undefined state after construction.
             *
             ...
             *
             * Moves the properties of \a rhs into \a this. \a this will be identical to \a rhs's state before the
             * move. \a rhs will be in an undefined state after the assignment.
             *
