...
namespace bactria
{
    ...
    class Event : public Marker
    {
        public:
             ...
             *
             * The move constructor will move the contents of the original Event into this Event. The original
             * Event will be in an invalid state; using it is undefined behaviour.
             *
             * \param other The Event to be moved.
             */
            Event(Event&& other) noexcept
            : Marker(std::forward<Event>(other)), m_action{std::move(other.m_action)}
            {
             ...
             *
             * The move assignment operator will move the contents of the original Event into this Event. The original
             * Event will be in an invalid state; using it is undefined behaviour.
             *
            ...
            {
                Marker::operator=(std::forward<Event>(rhs));
             ...
             *
             * Firing the event generates an entry on the visualizer with this event's name, color and category.
             * While the interface requires the source file, the line number and the calling function, this
             * information may not be supported by all back-ends. In this case the parameters will be silently
             * ignored.
             * 
             ...
             *
             * This method allows to specify a user-defined action which generates the name. It will be executed
             * upon firing the event. This method will override the name specified in the constructor.
             *
